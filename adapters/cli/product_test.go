...
import (
	...
	mock_application "github.com/lrmiguel/golang-hexagonal-architecture/application/mocks"
...
func TestRun(t *testing.T) {
	...
	expectedResult := fmt.Sprintf("Product ID #%s with name %s has been created with price %f and status %s", productId, productName, productPrice, productStatus)
